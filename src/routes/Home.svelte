...
<div class="container">
    ...
    <div class="hero-section">
        <div class="hero-body">
            ...
            <p>
                <i style="color: orangered; position: relative; font-size: 1.3rem;" class="fa-solid fa-location-dot pulsating-icon"></i> 
                <span style="margin-left: .5em;">West Palm Beach, Florida</span>
            </p>
            <a class="link-btn cta" href="https://github.com/guifendjy/dom_master" target="_blank">
        ...
        <div class="footer">
            ...
            <div class="social-links">
                <div class="tooltip g-scale">
                    <a aria-label="github" href="https://github.com/guifendjy" target="_blank" class="link-btn cta">
                ...
                <div class="tooltip g-scale">
                    <a aria-label="linkedin" href="https://linkedin.com/in/dads-guifendjy-paul-4a950b260" target="_blank" class="link-btn cta g-scale">
                        <svg  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 50 50">
